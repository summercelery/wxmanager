 ...
 * 
 */
package springboot.core.util.security;
...
public class RSAKeys {
		...
		try {
			...
			for(Entry<Object, Object> entry:prop.entrySet()){
				...
				if(key.length>1&&"base64".equalsIgnoreCase(key[1])){
					keyFileType= RSASignatureTools.KeyStoreFileType.BASE64;
				}
	 ...
	 */
	public static void newKey(String sysid,String keyFile,RSASignatureTools.KeyStoreFileType keyType) throws BusinessException {
		try {
